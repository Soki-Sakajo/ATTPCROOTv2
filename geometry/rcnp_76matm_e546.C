...
const TString geoVersion = "rcnp_76matm_e546";
const TString FileName = geoVersion + ".root";
const TString FileName1 = geoVersion + "_geomanager.root";

// Names of the different used materials which are used to build the modules
// The materials are defined in the global media.geo file
const TString MediumGas = "rcnpATTPCIsoButane_76";
...
void create_materials_from_media_file()
{
   ...
   FairGeoMedium *disobutane = geoMedia->getMedium("rcnpATTPCIsoButane_76");
