...
void run_eve(int runNum = 130){

  TString OutputDataFile = "./decode_data/run_display.root";
  //  TString InputDataFile = TString::Format("~/fair_install/decode_data/run_%04d.root", runNum);
  ...
  std::cout << "Opening: " << InputDataFile << std::endl;
   ...
   //   TString geoFile = "rcnp_130matm_geomanager.root";
