...
void test_one_track(int run_number=42)
{
   ...
   TString outputfile ="~/fair_install/transfer_data/test/" + TString::Format("run_%04d.root", run_number);
   ...
   /*
   new_tree->Branch("vertexx", track_verx, "vertex/D");
   new_tree->Branch("vertexy", track_very, "vertex/D");
   new_tree->Branch("vertexz", track_verz, "vertex/D");
   */
