...
void run_eve_test2()  
{
  TString OutputDataFile = "./display/test2_display.root";
  TString InputDataFile = TString::Format("./decode_data/test2.root");
  std::cout << "Opening: " << InputDataFile << std::endl;
   ...
   TString OutputDataPath = "./display/" + OutputDataFile;
