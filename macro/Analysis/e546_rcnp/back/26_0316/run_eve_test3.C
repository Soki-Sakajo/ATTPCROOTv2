...
//void run_eve(int runNum = 116, TString OutputDataFile = "./run_0116_display.root")  
void run_eve_test3(int runNum = 52)  
{
  TString InputDataFile = TString::Format("./decode_data/run_%04d.root", runNum);
  TString OutputDataFile = TString::Format("./display/test3_display.root");
  //  TString OutputDataFile = "./run_0038_display.root";
  std::cout << "Opening: " << InputDataFile << std::endl;

   TString dir = getenv("VMCWORKDIR");
   //   TString geoFile = "ATTPC_C4H10_57_7torr_geomanager.root";
   TString geoFile = "rcnp_76matm_e546_geomanager_50.root";
