...
int sim_macro_sequential_1003(Int_t subnum=0){ 
  ...
  TString infname = outdir + "attpcsim_sequential_hoylehoyle_" + to_string(subnum) + ".root";
  ...
  TString digifname =
    //    "data1/output_digi_rcnp_hoylehoyle_" + to_string(subnum) + ".root";
    //    "data/output_digi_rcnp_sequential_hoylehoyle_" + to_string(subnum) + ".root";
    outdir + "output_digi_rcnp_sequential_hoylehoyle_" + to_string(subnum) + ".root";
  ...
  //  TString outfname = "data1/sim_macro_hoylehoyle_" + to_string(subnum) + ".root";
  //  TString outfname = "data/sim_macro_sequential_hoylehoyle_" + to_string(subnum) + ".root";
  TString outfname = outdir + "sim_macro_sequential_hoylehoyle_" + to_string(subnum) + ".root";
  ...
  //  TString outcan = "data1/can_sim_macro_hoyle_"+ to_string(subnum) +".C";
  //  TString outcan = "data/can_sim_macro_sequential_hoyle_"+ to_string(subnum) +".C";
  TString outcan = outdir + "can_sim_macro_sequential_hoyle_"+ to_string(subnum) +".C";
  can->SaveAs(outcan);
