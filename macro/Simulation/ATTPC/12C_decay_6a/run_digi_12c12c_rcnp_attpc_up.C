...
void run_digi_12c12c_rcnp_attpc_up(int subnum=0)
{
  ...
  TString outputFile=
    ...
    inOutDir + "output_digi_rcnp_sequential_hoylehoyle_up_" + std::to_string(subnum) + ".root";
  
  TString scriptfile = "Lookup20150611.xml";
  
  //  TString paramFile = "ATTPC.e20009_sim.par";
  TString paramFile = "rcnp_attpc_up.par";
