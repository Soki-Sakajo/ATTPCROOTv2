...
void run_digi_12c12c_rcnp_attpc_up_nd(int subnum=0)
{
  //  TString inOutDir = "./data/";
  TString inOutDir = "./data1/";

  TString outputFile=
    //    inOutDir + "output_digi_rcnp_hoylehoyle_nd_" + std::to_string(subnum) + ".root";
    inOutDir + "output_digi_rcnp_sequential_hoylehoyle_up_nd_" + std::to_string(subnum) + ".root";
  
  TString scriptfile = "Lookup20150611.xml";
  
  //  TString paramFile = "ATTPC.e20009_sim.par";
  TString paramFile = "rcnp_attpc_up_nd.par";
  
  TString dir = getenv("VMCWORKDIR");
  
  //  TString mcFile = inOutDir + "attpcsim_hoylehoyle_"+ to_string(subnum) +".root";
  TString mcFile = inOutDir + "attpcsim_sequential_hoylehoyle_"+ to_string(subnum) +".root";
