...
int check_hoyle_dire_0820(Int_t subnum=0){ 
  ...
  //  TH2F *h_hoy=new TH2F("h_hoy","reaction position: exenergy of hoyle",200,0,200,100,7.6,7.8);
  ...
  //  TH1F *h_ex=new TH1F("h_ex","excitation energy",100,7.64,7.74);
  ...
  //  TH1F *h_ex_dep=new TH1F("h_ex_dep","excitation energy in 100-110",100,7.6,7.8);
  //  TH1F *h_ex_dep=new TH1F("h_ex_dep","excitation energy in 100-110",100,7.64,7.74);
  ...
  //  TH1F *h_ex_ang=new TH1F("h_ex_ang","excitation energy in 0-10",100,7.64,7.74);
  TH1F *h_ex_ang=new TH1F("h_ex_ang","excitation energy of hoyle2",100,7.64,7.74);
  //  TH1F *h_rmax=new TH1F("h_ex_rmax","excitation energy in 20-30",100,7.64,7.74);
  TH2F *h_rmax=new TH2F("h_rmax","reaction position: (Ebeam-Esum6alpha)/2",180,0,180,100,7.27,7.285);
  //  TH1F *h_rmaxnd=new TH1F("h_ex_rmaxnd","excitation energy in 170-180",100,7.64,7.74);
  ...
  for(int i=0;i < nEvents; i++){
	...
	h_rmax->Fill(z[1],(tener-Esum6)/2);
	h_rmaxnd->Fill(z[1],tener-Esum6);
