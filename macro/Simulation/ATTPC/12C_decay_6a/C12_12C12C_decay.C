void C12_12C12C_decay(Int_t nEvents = 1000, Int_t subnum=0)
{
  ...
  //  TString outFile = OutDir + "attpcsim_12c12c_"+ to_string(subnum) +".root";
  TString outFile = OutDir + "attpcsim_hoylehoyle_"+ to_string(subnum) +".root";
  
  // Parameter file name
  //  TString parFile = "./data/attpcpar_C12C12.root";
  //  TString parFile = OutDir + "attpcpar_12c12c_"+ to_string(subnum) +".root";
  TString parFile = OutDir + "attpcpar_hoylehoyle_"+ to_string(subnum) +".root";
  ...
  //  TString outgeoFile = "./data/geofile_full.root";
  //  TString outgeoFile = OutDir + "geofile_full_12c12c_"+ to_string(subnum) +".root";
  TString outgeoFile = OutDir + "geofile_full_hoylehoyle_"+ to_string(subnum) +".root";
