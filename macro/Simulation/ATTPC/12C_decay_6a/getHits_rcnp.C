...
void getHits_rcnp(int eventNumber = 7){

  double fThreshold = 0; // Only save hits if they're above this threshold
  TChain tpc_tree("cbmsim");
  //   tpc_tree.Add("./data1/output_digi_rcnp_hoylehoyle_nd_0.root");
  //   tpc_tree.Add("./data1/output_digi_rcnp_hoylehoyle_0.root");
  //   tpc_tree.Add("./data1/output_digi_rcnp_sequential_hoylehoyle_down_nd_0.root");
  //   tpc_tree.Add("./data1/output_digi_rcnp_sequential_hoylehoyle_down_0.root");
  //   tpc_tree.Add("./data1/output_digi_rcnp_sequential_hoylehoyle_down_nd_0.root");
  //   tpc_tree.Add("./data1/output_digi_rcnp_sequential_hoylehoyle_nd_0.root");
  //   tpc_tree.Add("./data1/output_digi_rcnp_sequential_hoylehoyle_up_0.root");
