...
int sim_macro_0704_20matm(Int_t subnum=0){ 
  ...
  TString infname = "data1/attpcsim_20matm_" + to_string(subnum) + ".root";
  TFile *file =new TFile(infname);  
  TTree *tree = (TTree*)file->Get("cbmsim");
  
  // digi data input
  TChain tpc_tree("cbmsim");
  TString digifname = "data1/output_digi_20matm_" + to_string(subnum) + ".root";
  ...
  //set output
  TString outfname = "data1/sim_macro_20matm_" + to_string(subnum) + ".root";
