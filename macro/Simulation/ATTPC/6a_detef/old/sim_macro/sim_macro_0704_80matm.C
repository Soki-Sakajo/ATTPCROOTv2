...
int sim_macro_0704_80matm(Int_t subnum=0){ 
  ...
  TString infname = "data1/attpcsim_80matm_" + to_string(subnum) + ".root";
  TFile *file =new TFile(infname);  
  TTree *tree = (TTree*)file->Get("cbmsim");
  
  // digi data input
  TChain tpc_tree("cbmsim");
  TString digifname = "data1/output_digi_80matm_" + to_string(subnum) + ".root";
  ...
  //set output
  TString outfname = "data1/sim_macro_80matm_" + to_string(subnum) + ".root";
