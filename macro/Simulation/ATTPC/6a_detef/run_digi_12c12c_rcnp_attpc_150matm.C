...
void run_digi_12c12c_rcnp_attpc_150matm(int subnum=0)
{
  ...
  TString outputFile=
    ...
    inOutDir + "output_digi_rcnp_sequential_hoylehoyle_150matm_" + std::to_string(subnum) + ".root";
  
  TString scriptfile = "Lookup20150611.xml";
  
  //  TString paramFile = "ATTPC.e20009_sim.par";
  //  TString paramFile = "rcnp_attpc.par";
  TString paramFile = "rcnp_attpc_150matm.par";
  
  TString dir = getenv("VMCWORKDIR");
  
  //  TString mcFile = inOutDir + "attpcsim_hoylehoyle_"+ to_string(subnum) +".root";
  TString mcFile = inOutDir + "attpcsim_sequential_hoylehoyle_150matm_"+ to_string(subnum) +".root";
