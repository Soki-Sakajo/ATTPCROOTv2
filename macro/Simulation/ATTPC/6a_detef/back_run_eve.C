...
{
  //   TString InputDataFile = TString::Format("./data/output_digi_rcnp_sequential_hoylehoyle_80matm_1.root", runNum);
   TString InputDataFile = TString::Format("./data/output_digi_rcnp_sequential_hoylehoyle_80matm_1.root");
