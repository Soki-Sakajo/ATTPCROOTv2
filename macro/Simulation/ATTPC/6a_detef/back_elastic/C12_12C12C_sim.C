void C12_12C12C_sim(Int_t nEvents = 1000, Int_t subnum=0)
{
   ...
   //   TString outFile = "./data1/attpcsim_12c12c_30matm_" + to_string(subnum) + ".root";
   TString outFile = "./data1/attpcsim_12c12c_50matm_" + to_string(subnum) + ".root";
   ...
   //   TString parFile = "./data1/attpcpar_12c12c_30matm_" + to_string(subnum) + ".root";
   TString parFile = "./data1/attpcpar_12c12c_50matm_" + to_string(subnum) + ".root";
   ...
   ATTPC->SetGeometryFileName("rcnp_50matm.root");
  ...
  // -----   Magnetic field   -------------------------------------------
   ...
   Double_t pz = 1.05842978 / a; // Z-Momentum GeV/ per nucleon!!!!!!
   ...
   TString outgeoFile = "./data1/geofile_full_12c12c_50matm_" + to_string(subnum) + ".root";
