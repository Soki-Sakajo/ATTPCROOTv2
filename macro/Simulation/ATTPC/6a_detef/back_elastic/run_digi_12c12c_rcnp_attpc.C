...
void run_digi_12c12c_rcnp_attpc(int subnum=0)
{
  ...
  //  TString outputFile = inOutDir + "output_digi_rcnp_12c_30matm_" + std::to_string(subnum) + ".root";
  TString outputFile = inOutDir + "output_digi_rcnp_12c_50matm_" + std::to_string(subnum) + ".root";
  ...
  //  TString mcFile = inOutDir + "attpcsim_12c12c_30matm_" + std::to_string(subnum) + ".root";
  TString mcFile = inOutDir + "attpcsim_12c12c_50matm_" + std::to_string(subnum) + ".root";
