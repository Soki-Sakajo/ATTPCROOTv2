...
int sim_macro_sequential_1003_70matm(Int_t subnum=0){ 
  ...
  TString infname =
    outdir + "attpcsim_sequential_hoylehoyle_70matm_" + to_string(subnum) + ".root";
  ...
  TString digifname =
    ...
    outdir + "output_digi_rcnp_sequential_hoylehoyle_70matm_" + to_string(subnum) + ".root";
  ...
  TString outfname =
    outdir + "sim_macro_sequential_hoylehoyle_70matm_" + to_string(subnum) + ".root";
  ...
  TString outcan =
    outdir + "can_sim_macro_sequential_hoyle_70matm_"+ to_string(subnum) +".C";
  can->SaveAs(outcan);
