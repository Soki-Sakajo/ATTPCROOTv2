...
int sim_macro_sequential_nd_1003(Int_t subnum=0){ 
  ...
  TString digifname =
    ...
    outdir + "output_digi_rcnp_sequential_hoylehoyle_nd_" + to_string(subnum) + ".root";
  ...
  TString outfname = outdir + "sim_macro_sequential_hoylehoyle_nd_" + to_string(subnum) + ".root";
  ...
  TString outcan = outdir + "can_sim_macro_sequential_hoyle_nd_"+ to_string(subnum) +".C";
  can->SaveAs(outcan);
