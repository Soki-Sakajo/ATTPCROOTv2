...
int check_depth_ener(Int_t subnum=0){
  ...
  Double_t starty[6];
  Double_t startz[6];
  Double_t theta_lab[6];
  Double_t theta_cms[6];
  Double_t x[6];
  Double_t y[6];
  Double_t z[6];
  ...
  //  TString refi="data1/sim_macro_0912_130matm_"+ to_string(subnum)+".root";
  TString refi="data1/sim_macro_130matm_"+ to_string(subnum)+".root";
