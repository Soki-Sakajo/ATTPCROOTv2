void C12_12C12C_decay_sequential_80matm(Int_t nEvents = 10000, Int_t subnum=0)
{
  ...
  TString parFile =
    OutDir +"attpcpar_sequential_hoylehoyle_80matm_"+ to_string(subnum) +".root";
  ...
  //  Double_t pz = 1.17128149 / a; // Z-Momentum / per nucleon!!!!!!
  Double_t pz = 1.241135 / a; // Z-Momentum / per nucleon!!!!!!
  Double_t BExcEner = 0.0;
  Double_t Bmass = 12.0;
  //  Double_t NomEnergy = 40.0;
  //  Double_t NomEnergy = 20.0;
  Double_t NomEnergy = 30.0;
  ...
  TString outgeoFile =
    OutDir + "geofile_full_sequential_hoylehoyle_80matm_"+ to_string(subnum) +".root";
