void C12_decay_130matm(Int_t nEvents = 10000, Int_t subnum=0)
{
  TString dir = getenv("VMCWORKDIR");
  
  // Output file name
  TString OutDir = "./data1/";
  TString outFile = OutDir + "attpcsim_130matm_"+ to_string(subnum) +".root";
  
  // Parameter file name
  TString parFile = OutDir + "attpcpar_130matm_"+ to_string(subnum) +".root";
  ...
  TString outgeoFile = OutDir + "geofile_full_130matm_"+ to_string(subnum) +".root";
