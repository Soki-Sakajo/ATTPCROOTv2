...
void run_digi_150matm(int subnum=0)
{
  TString inOutDir = "./data1/";
  TString outputFile=inOutDir + "output_digi_150matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_150matm_"+ to_string(subnum) +".root";
