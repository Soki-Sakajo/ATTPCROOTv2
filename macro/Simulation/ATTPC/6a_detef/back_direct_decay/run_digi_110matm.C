...
void run_digi_110matm(int subnum=0)
{
  TString inOutDir = "./data1/";
  TString outputFile=inOutDir + "output_digi_110matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_110matm_"+ to_string(subnum) +".root";
