...
void run_digi_80matm(int subnum=0)
{
  TString inOutDir = "./data1/";
  TString outputFile=inOutDir + "output_digi_80matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_80matm_"+ to_string(subnum) +".root";
