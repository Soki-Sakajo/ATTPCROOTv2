...
void run_digi_40matm(int subnum=0)
{
  TString inOutDir = "./data1/";
  TString outputFile=inOutDir + "output_digi_40matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_40matm_"+ to_string(subnum) +".root";
