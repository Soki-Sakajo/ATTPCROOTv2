...
void run_digi_30matm(int subnum=0)
{
  TString inOutDir = "./data1/";
  TString outputFile=inOutDir + "output_digi_30matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_30matm_"+ to_string(subnum) +".root";
