...
int check_hoyle_state_0810(Int_t gasp=130 ,Int_t subnum=0){ 
  ...
  TString refi="data1/sim_macro_"+ to_string(gasp)+"matm_"+ to_string(subnum) +".root";
  ...
  TString outcan ="data1/check_hoyle_"+to_string(gasp)+"matm_"+to_string(subnum)+".C";
  can->SaveAs(outcan);
