...
void run_digi_12c12c_rcnp_attpc_90matm(int subnum=0)
{
  ...
  TString outputFile=
    ...
    inOutDir + "output_digi_rcnp_sequential_hoylehoyle_90matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_sequential_hoylehoyle_90matm_"+ to_string(subnum) +".root";
