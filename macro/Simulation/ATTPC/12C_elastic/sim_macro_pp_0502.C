...
int sim_macro_pp_0502(Int_t subnum=0){ 
  ...
  TString digifname = "data1/output_digi_rcnp_p_" + to_string(subnum) + ".root";
  ...
  //set output
  TString outfname = "data1/sim_macro_p_" + to_string(subnum) + ".root";
