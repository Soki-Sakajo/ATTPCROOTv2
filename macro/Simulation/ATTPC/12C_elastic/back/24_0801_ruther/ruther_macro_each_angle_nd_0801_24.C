...
int ruther_macro_each_angle_nd_0711_24(Int_t subnum=1){ 
  ...
  //for all (12c12c 12cp)
  TTree *rutal = new TTree("rutp","rutp");
  TTree *expap = new TTree("exppp","exppp");
  TTree *expal = new TTree("exppl","exppl");
  TTree *expaa = new TTree("exppa","exppa");
  TTree *expav = new TTree("exppv","exppv");
  TTree *expab = new TTree("exppb","exppb");
  TTree *expao = new TTree("exppo","exppo");
  ...
  expaa->Branch("number_of_particle_angle",&n_epa,"n_epa/I");
  expav->Branch("file_angle_over90",&n_efv,"n_fiv/I");
  expav->Branch("event_number_angle_over90",&n_eev,"n_eev/I");
  expav->Branch("number_of_particle_angle_over90",&n_epv,"n_epv/I");
  ...
  */
  ...
  //output for canvas
  TString outcan = "data1/ruther_can_nd_0711_" + to_string(subnum) + ".C";
  can->SaveAs(outcan);
  h_z->Write();
  h_rmax->Write();
  h_rmax_nd->Write();
