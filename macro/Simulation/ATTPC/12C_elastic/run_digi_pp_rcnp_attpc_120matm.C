...
void run_digi_pp_rcnp_attpc_120matm(int subnum=0){
  ...
  //  TString outputFile = inOutDir + "output_digi_rcnp_p_120matm_" + std::to_string(subnum) + ".root";
  TString outputFile ="data1/output_digi_rcnp_p_120matm_" + std::to_string(subnum) + ".root";
  //  TString outputFile ="data1/output_digi_rcnp_p_120matm_D130_" + std::to_string(subnum) + ".root";
  ...
  //  TString mcFile = inOutDir + "attpcsim_pp_120matm_" + std::to_string(subnum) + ".root";
  TString mcFile = "data2/attpcsim_pp_120matm_" + std::to_string(subnum) + ".root";
