...
int ruther_macro_each_angle_0711_24_120matm(Int_t subnum=30){
  ...
  for(int i=0; i<subnum; i++){
    ...
    TString refi="sim_macro_12c_120matm_" + to_string(i) + ".root";
    //    TString refi="sim_macro_12c_120matm_D130_" + to_string(i) + ".root";
  ...
  for(int i=0; i<subnum; i++){
    TString refi="sim_macro_p_120matm_" + to_string(i) + ".root";
    //    TString refi="sim_macro_p_120matm_D130_" + to_string(i) + ".root";
    TString direfi=dir+"/"+refi;
    tree2->Add(direfi);
    if(i==0){cout<<"read from  "<<refi<<flush;}
    if(i==subnum-1){cout<<"  to  "<<refi<<endl;}
  ...
  TString outdata = dir+"/rutdata_0711_24_120matm_" + to_string(subnum) + ".root";
  //  TString outdata = dir+"/rutdata_0711_24_120matm_D130_" + to_string(subnum) + ".root";
  //set output canvas
  TString outcan = dir+"/ruther_can_0711_120matm_" + to_string(subnum) + ".C";
  //  TString outcan = dir+"/ruther_can_0711_120matm_D130_" + to_string(subnum) + ".C";
