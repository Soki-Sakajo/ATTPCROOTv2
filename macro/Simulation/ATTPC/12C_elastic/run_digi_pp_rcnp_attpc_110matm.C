...
void run_digi_pp_rcnp_attpc_110matm(int subnum=0)
{
  ...
  TString outputFile = inOutDir + "output_digi_rcnp_p_110matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_pp_110matm_" + std::to_string(subnum) + ".root";
