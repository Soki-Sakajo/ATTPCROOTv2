...
int ruther_macro_each_angle_0711_24_130matm(Int_t subnum=30){
  ...
  TString outdata = dir+"/rutdata_0711_24_130matm_" + to_string(subnum) + ".root";
  ...
  */
  ...
  //output for canvas
  TString outcan = dir+"/ruther_can_0711_130matm_" + to_string(subnum) + ".C";
  can->SaveAs(outcan);
  h_z->Write();
  h_rmax->Write();
  h_rmax_nd->Write();
