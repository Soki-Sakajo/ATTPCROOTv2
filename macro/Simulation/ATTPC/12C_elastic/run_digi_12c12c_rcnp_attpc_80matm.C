...
void run_digi_12c12c_rcnp_attpc_80matm(int subnum=0)
{
  ...
  TString outputFile = inOutDir + "output_digi_rcnp_12c_80matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_12c12c_80matm_" + std::to_string(subnum) + ".root";
