...
void run_digi_12c12c_rcnp_attpc_130matm(int subnum=0)
{
  ...
  //  TString outputFile = inOutDir + "output_digi_rcnp_12c_130matm_" + std::to_string(subnum) + ".root";
  TString outputFile = "data1/output_digi_rcnp_12c_130matm_" + std::to_string(subnum) + ".root";
  ...
  //  TString mcFile = inOutDir + "attpcsim_12c12c_130matm_" + std::to_string(subnum) + ".root";
  TString mcFile = "data2/attpcsim_12c12c_130matm_" + std::to_string(subnum) + ".root";
