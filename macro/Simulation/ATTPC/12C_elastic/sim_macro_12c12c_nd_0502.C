...
int sim_macro_12c12c_nd_0502(Int_t subnum=0){ 
  ...
  TString digifname = "data1/output_digi_rcnp_12c_nd_" + to_string(subnum) + ".root";
  ...
  //set output
  TString outfname = "data1/sim_macro_12c_nd_" + to_string(subnum) + ".root";
