...
int sim_macro_pp_0502_120matm(Int_t subnum=0){ 
  ...
  //input
  //  TString infname = "data1/attpcsim_pp_120matm_" + to_string(subnum) + ".root";
  TString infname = "data2/attpcsim_pp_120matm_" + to_string(subnum) + ".root";
  TFile *file =new TFile(infname);  
  TTree *tree = (TTree*)file->Get("cbmsim");
  
  // digi data input
  TChain tpc_tree("cbmsim");
  //  TString digifname = "data1/output_digi_rcnp_p_120matm_" + to_string(subnum) + ".root";
  TString digifname = "data1/output_digi_rcnp_p_120matm_D130_" + to_string(subnum) + ".root";
  //  TString digifname = "data2/output_digi_rcnp_p_120matm_" + to_string(subnum) + ".root";
  ...
  //set output
  //  TString outfname = "data1/sim_macro_p_120matm_" + to_string(subnum) + ".root";
  //  TString outfname = "data2/sim_macro_p_120matm_" + to_string(subnum) + ".root";
  TString outfname = "data2/sim_macro_p_120matm_D130_" + to_string(subnum) + ".root";
