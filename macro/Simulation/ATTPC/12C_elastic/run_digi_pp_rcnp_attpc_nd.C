...
void run_digi_pp_rcnp_attpc_nd(int subnum=0)
{
  ...
  TString outputFile = inOutDir + "output_digi_rcnp_p_nd_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_pp_" + std::to_string(subnum) + ".root";
