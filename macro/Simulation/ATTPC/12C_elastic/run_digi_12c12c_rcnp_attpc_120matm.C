...
void run_digi_12c12c_rcnp_attpc_120matm(int subnum=0){

  //  TString inOutDir = "./data/";
  TString inOutDir = "./data1/";
  //  TString inOutDir = "./data2/";
  
  //   TString outputFile = inOutDir + "output_digi.root";
  //   TString outputFile = inOutDir + "output_digi_rcnp_12c.root";
  //  TString outputFile = inOutDir + "output_digi_rcnp_12c_120matm_" + std::to_string(subnum) + ".root";
  TString outputFile = "data1/output_digi_rcnp_12c_120matm_" + std::to_string(subnum) + ".root";
  //  TString outputFile = "data1/output_digi_rcnp_12c_120matm_D130_" + std::to_string(subnum) + ".root";

  TString scriptfile = "Lookup20150611.xml";
  
  //  TString paramFile = "ATTPC.e20009_sim.par";
  //  TString paramFile = "rcnp_attpc.par";
  TString paramFile = "rcnp_attpc_120matm.par";
  //  TString paramFile = "rcnp_attpc_130matm.par";
  ...
  //  TString mcFile = inOutDir + "attpcsim_12c12c_120matm_" + std::to_string(subnum) + ".root";
  TString mcFile ="data2/attpcsim_12c12c_120matm_" + std::to_string(subnum) + ".root";
