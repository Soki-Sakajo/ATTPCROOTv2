...
int ruther_macro_each_angle_nd_0502_24(Int_t subnum=1){ 
  ...
  Int_t theta_min=5;    // deg; rutherford scattar angle
  Int_t theta_max=175;    // deg; rutherford scattar angle
  ...
  //  TF1 *f1=new TF1("f1","[0]*sin([1]*x)*(1/(sin([1]*x/2)*sin([1]*x/2)*sin([1]*x/2)*sin([1]*x/2))+1/(cos([1]*x/2)*cos([1]*x/2)*cos([1]*x/2)*cos([1]*x/2)))",theta_min,181-theta_min);
  ...
  //  TF1 *f2=new TF1("f2","[0]*sin([1]*x)*(1/(sin([1]*x/2)*sin([1]*x/2)*sin([1]*x/2)*sin([1]*x/2)))",theta_min,181-theta_min);
  ...
  */
  ...
  //output for canvas
  TString outcan = "data1/ruther_can_nd_0502_" + to_string(subnum) + ".C";
  can->SaveAs(outcan);
  h_z->Write();
  h_rmax->Write();
  h_rmax_nd->Write();
