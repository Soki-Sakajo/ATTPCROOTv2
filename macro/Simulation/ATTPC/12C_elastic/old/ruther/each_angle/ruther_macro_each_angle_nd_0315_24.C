...
int ruther_macro_each_angle_nd_0315_24(Int_t subnum=1){ 
  ...
  TString outdata = "data1/rutdata_nd_" + to_string(subnum) + ".root";
  ...
  */
  ...
  //output for canvas
  TString outcan = "data1/ruther_can_nd_0315_" + to_string(subnum) + ".C";
  can->SaveAs(outcan);
  h_z->Write();
  h_rmax->Write();
  h_rmax_nd->Write();
