...
void run_digi_extract_12c12c(int subnum=0, Int_t nEvent=0)
{
   TString inOutDir = "./data1/";
   //   TString outputFile = inOutDir + "output_digi_rcnp_12c_" + to_string(subnum) + ".root";   

  TString outputFile = inOutDir + "output_digi_extract_c12_" + to_string(subnum)+"_"+ to_string(nEvent)+ ".root";
   ...
   //   TString mcFile = inOutDir + "attpcsim_12c12c_" + to_string(subnum) + ".root";   

  TString mcFile = inOutDir + "extract_c12_" + to_string(subnum)+"_"+ to_string(nEvent)+ ".root";
