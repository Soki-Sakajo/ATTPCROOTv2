...
void run_digi_pp_rcnp_attpc(int subnum=0)
{
   TString inOutDir = "./data1/";
   //   TString outputFile = inOutDir + "output_digi.root";
   //   TString outputFile = inOutDir + "output_digi_rcnp_p.root";
   TString outputFile = "./data1/output_digi_rcnp_p_" + std::to_string(subnum) + ".root";
   ...
   //   TString mcFile = inOutDir + "attpcsim_pp.root";
   TString mcFile = "./data1/attpcsim_pp_" + std::to_string(subnum) + ".root";
