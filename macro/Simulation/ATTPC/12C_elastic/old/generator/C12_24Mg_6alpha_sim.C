void C12_24Mg_6alpha_sim(Int_t nEvents = 1000)
//void C12_24Mg_6alpha_sim(Int_t nEvents = 1000, Int_t subnum=0)
{

   TString dir = getenv("VMCWORKDIR");

   // Output file name
   TString outFile = "./data/attpcsim_24Mg_6alpha.root";

   // Parameter file name
   TString parFile = "./data/attpcpar_24Mg_6alpha.root";
   ...
   Double_t pz = 1.058294 / a; // Z-Momentum / per nucleon!!!!!!
   ...
   Pzp.push_back(0.0);
   Mass.push_back(12); // uma
   ExE.push_back(19.5); // need to modify
   ...
   for (auto i = 0; i < 6; ++i) { // 6 alpha particles
