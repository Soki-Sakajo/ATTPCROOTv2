void pad_plot(Int_t eve_num=1){
  ...
  //  TString outcan="./can_padplane/can_padplane_12c_130matm_0-"+ to_string(eve_num) +".pdf";
  //  TString outcan="./can_padplane/can_padplane_p_130matm_0-"+ to_string(eve_num) +".pdf";
  ...
  //for 12c12c
  /*
  TCanvas *can=new TCanvas("hists","hists",1300,1100);
  can->cd(1);
  padplane->SetStats(0);
  can->SetLeftMargin(0.15);
  can->SetRightMargin(0.19);
  ...
  padplane->GetZaxis()->SetTitleOffset(1.1);
  gStyle->SetOptTitle(0);
  gPad->Update();
  */
  //for 12cp

  TCanvas *can=new TCanvas("hists","hists",1300,1050);
  can->cd(1);
  padplane->SetStats(0);
  can->SetLeftMargin(0.15);
  ...
  padplane->GetYaxis()->SetTitleOffset(1.2);
  padplane->GetZaxis()->SetTitleSize(0.06);
  padplane->GetZaxis()->SetTitleOffset(1.4);
  gStyle->SetOptTitle(0);
  gPad->Update();
