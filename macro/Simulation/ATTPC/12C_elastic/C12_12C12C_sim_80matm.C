void C12_12C12C_sim_80matm(Int_t nEvents = 100000, Int_t subnum=0)
{
   ...
   //   TString outFile = "./data/attpcsim_12c12c_" + to_string(subnum) + ".root";
   //   TString outFile = "./data1/attpcsim_12c12c_80matm_" + to_string(subnum) + ".root";
   TString outFile = "./data2/attpcsim_12c12c_80matm_" + to_string(subnum) + ".root";

   // Parameter file name
   //   TString parFile = "./data/attpcpar.root";
   //   TString parFile = "./data/attpcpar_12c12c.root";
   //   TString parFile = "./data/attpcpar_12c12c_" + to_string(subnum) + ".root";
   //   TString parFile = "./data1/attpcpar_12c12c_80matm_" + to_string(subnum) + ".root";
   TString parFile = "./data2/attpcpar_12c12c_80matm_" + to_string(subnum) + ".root";
   ...
   ATTPC->SetGeometryFileName("rcnp_80matm.root");
   ...
   //   Double_t pz = 1.05842978 / a; // Z-Momentum GeV/ per nucleon!!!!!! 50 MeV
   Double_t pz = 1.17128149 / a; // Z-Momentum GeV/ per nucleon!!!!!!
   Double_t BExcEner = 0.0;
   Double_t Bmass = 12;
   //   Double_t Bmass = 11.99671;
   
   //   Double_t NomEnergy = 48.5;
   //   Double_t NomEnergy = 20.0;
   Double_t NomEnergy = 59.0;
   ...
   //   TString outgeoFile = "./data/geofile_full_12c12c_" + to_string(subnum) + ".root";
   TString outgeoFile = "./data2/geofile_full_12c12c_80matm_" + to_string(subnum) + ".root";
