...
void pad_plot_time(Int_t eve_num=0){
  ...
  //  Double_t q_t=1e4; //only fill hists if they're above this thereshold
  TChain tpc_tree("cbmsim");

  tpc_tree.Add("./data1/output_digi_rcnp_12c_130matm_0.root");
  //  tpc_tree.Add("./data1/output_digi_rcnp_p_130matm_0.root");
  ...
  //  TString outcan3="./pdf_output/can_padplane_part_12c_130matm_0-"+ to_string(eve_num) +".pdf";
  //  TString outcan3="./pdf_output/can_padplane_part_p_130matm_0-"+ to_string(eve_num) +".pdf";
  ...
  */
  TCanvas *can1=new TCanvas("hist1","hist1",1000,1008);
  can1->cd(1);
  //  can1->SetLeftMargin(0);
  //  can1->SetRightMargin(0);
  //  can1->SetTopMargin(0);
  //  can1->SetBottomMargin(0);
  padplane4->SetStats(0);
  /*
  padplane4->GetXaxis()->SetRangeUser(-150,150);
  padplane4->GetYaxis()->SetRangeUser(-150,150);
  */
  padplane4->GetXaxis()->SetRangeUser(-275,275);
  padplane4->GetYaxis()->SetRangeUser(-275,275);
