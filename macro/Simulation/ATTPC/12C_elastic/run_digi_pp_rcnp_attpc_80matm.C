...
void run_digi_pp_rcnp_attpc_80matm(int subnum=0)
{
  ...
  TString outputFile = inOutDir + "output_digi_rcnp_p_80matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_pp_80matm_" + std::to_string(subnum) + ".root";
