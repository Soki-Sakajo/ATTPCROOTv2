...
void run_digi_pp_rcnp_attpc_100matm(int subnum=0)
{
  ...
  TString outputFile = inOutDir + "output_digi_rcnp_p_100matm_" + std::to_string(subnum) + ".root";
  ...
  TString mcFile = inOutDir + "attpcsim_pp_100matm_" + std::to_string(subnum) + ".root";
