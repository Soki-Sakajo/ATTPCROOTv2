...
int sim_macro_12c12c_0502_90matm(Int_t subnum=0){ 
  ...
  //input
  //  TString infname = "data1/attpcsim_12c12c_90matm_" + to_string(subnum) + ".root";
  TString infname = "data2/attpcsim_12c12c_90matm_" + to_string(subnum) + ".root";
  TFile *file =new TFile(infname);  
  TTree *tree = (TTree*)file->Get("cbmsim");
  
  // digi data input
  TChain tpc_tree("cbmsim");
  //  TString digifname = "data1/output_digi_rcnp_12c_90matm_" + to_string(subnum) + ".root";
  TString digifname = "data2/output_digi_rcnp_12c_90matm_" + to_string(subnum) + ".root";
  ...
  //set output
  //  TString outfname = "data1/sim_macro_12c_90matm_" + to_string(subnum) + ".root";
  TString outfname = "data2/sim_macro_12c_90matm_" + to_string(subnum) + ".root";
